...
const imagens_conteudo_direita2 = document.querySelector("#homer_triste")
...
input.addEventListener("input", function () {
    ...
    if (/[^a-z, ]/.test(texto)) {
        ...
        const imagens_conteudo_direita2 = document.querySelector("#homer_triste").style.display = "flex"
        const imagens_conteudo_direita = document.querySelector("#homer_feliz").style.display = "none"
        ...
        const imagens_conteudo_direita = document.querySelector("#homer_feliz").style.display = "flex"
        const imagens_conteudo_direita2 = document.querySelector("#homer_triste").style.display = "none"
